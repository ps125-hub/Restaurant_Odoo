...
class InvoiceModel(models.Model):
    ...
    base = fields.Float(string ='Base', help = 'Base price of a invoice',compute ='_priceBase',store=True,required =True,readonly=1, default =0)
    vat = fields.Selection(string ='VAT', help = 'VAT of a invoice',selection =[('0','0%'),('4','4%'),('10','10%'),('21','21%')],required = True,default='10')
    total = fields.Float(string='Total', help = 'Total of a invoice',compute ='_totalPrice',store=True,required =True, default =0,readonly=1)
